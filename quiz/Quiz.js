...
const quizData = [
            ...
            quizData.forEach((currentQuestion, index) => { 
                           ...
                           for(item in currentQuestion.answers){
                              ...
                              <h3>Question ${index+1} of ${quizData.length}</h3>
                                    ...
                                    <div class="answer"><br>${answers.join('<br><hr style="background-color: rgb(245, 117, 138);"><br>')}</div>
                                </div>
    ...
    function showResult(){
            ...
            quizData.forEach( (currentQuestion, questionNum)=>{  
                ...
                resultDisplay.innerHTML = `<h3>${numCorrect}/${quizData.length}</h3>`; 
                scoreDisplay.innerHTML = `<h3>${score}점</h3>`; 
    }
